...
\section{Radioactivity and Reactor Physics}
\label{sec:phys}
    ...
    Krane's text \cite{k88} and chapter $1$ in Lilley's text \cite{l01}.
        ...
        N_0 e^{}-\lamba t}dt$. Hence we have
        \begin{equation}
    ...
    \subsection{Biological Effects of Radiation}
        ...
        of energy $E_{\gamma}$
        (in MeV), one can approximate the dose rate by \cite[chapt. 7]{l01}
        \begin{equation}
    ...
    \subsubsection{Nuclear cross-section}
    \subsubsection{Exponential decay law}
    \subsubsection{Shielding medium}
    \subsection{Fission}
    \label{sec:fission}
    ...
    the next section. Here we give an example of radiative capture. When a stable form
